...
const SocialButtons = () => {
    return (
        <div className="socialButtons">
            ...
            <a href='https://www.instagram.com/iamriteshsingh__/' target='_blank' className="btn twitter"><FaTwitter/></a>
            <a href='https://twitter.com/iamriteshsingh_' target='_blank' className="btn instagram "><FaInstagram/></a>
